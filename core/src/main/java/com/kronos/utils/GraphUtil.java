...
public class GraphUtil {
    public static JoinPhysicalGraph convertToPhysicalGraph(LogicalGraph streamGraph) {
        ...
        JoinPhysicalGraph graph =
                new JoinPhysicalGraph(
                        tPhysicalNode, streamGraph.getSinkerId(), streamGraph.getMapping());

        return graph;
    }

    @VisibleForTesting
    public static TPhysicalNode convertToPhysicalNode(
            TransformerLogicalNode node, TPhysicalNode root) {
