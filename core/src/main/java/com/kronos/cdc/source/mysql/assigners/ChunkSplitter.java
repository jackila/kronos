...
import com.kronos.cdc.source.mysql.source.utils.ChunkUtils;
import com.kronos.cdc.source.mysql.source.utils.ObjectUtils;
...
class ChunkSplitter {
    ...
    private static boolean isEvenlySplitColumn(Column splitColumn) {
        LogicalTypeRoot typeRoot = MySqlTypeUtils.convertFromColumn(splitColumn);
